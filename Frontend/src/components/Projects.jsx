...
const Projects = () => {
    ...
    //const [workData, setWorkData] = useState(Projectara);
            ...
            {workData.map((curElem)=>{
                ...
                <div className="project-card" key={curElem.id}>
                    ...
                    <div className="project-card-gradient pt-4 lg:p-6 lg:pt-4 2xl:p-12 2xl:pt-8">
                        ...
                        <p className="text-sm lg:text-sm 2xl:text-base mb-3">{curElem.desc}</p>
                        <p className="text-sm lg:text-sm 2xl:text-base mb-3">{curElem.techs}</p>
